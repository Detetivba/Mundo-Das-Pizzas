    ...
    //Função para exibir boas-vindas personalizadas
    function welcomeButton() {
        const nome = prompt("Digite seu nome:");
        document.getElementById("mensagem-boas-vindas").innerText = `Bem-vindo(a), ${nome}! Escolha suas pizzas favoritas e aproveite!`;
    }
